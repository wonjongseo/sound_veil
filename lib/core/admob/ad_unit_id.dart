...
//IOS APP ID  ca-app-pub-9712392194582442~7716751608
//IOS Banner ID  ca-app-pub-9712392194582442/6979989663

// ANDROID APP ID ca-app-pub-9712392194582442~8838261589
// Banner ID ca-app-pub-9712392194582442/3926923670
class AdUnitId {
  ...
  AdUnitId() {
    if (kReleaseMode) {
      ...
      banner = {
        'ios': 'ca-app-pub-9712392194582442/6979989663',
        'android': 'ca-app-pub-9712392194582442/3926923670',
      };
      jlptInterstitial = {
